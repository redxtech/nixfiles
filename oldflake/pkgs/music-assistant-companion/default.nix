...
let
  ...
  src = fetchurl {
    url = "https://github.com/music-assistant/companion/releases/download/v${version}/Music.Assistant.Companion_${version}_amd64.AppImage";
...
appimageTools.wrapType2 {
  ...
  meta = with lib; {
    ...
    changelog = "https://github.com/music-assistant/companion/releases/tag/v${version}";
