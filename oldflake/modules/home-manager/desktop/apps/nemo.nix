      ...
      let
        ...
        actions = {
          clamscan = {
            ...
            exec = "${kitty} ${kittySize} ${fish} -c '${clamav} %F; read -n 1 -p \"echo Press any key to continue...\"'";
            icon = "bug-buddy";
            selection = "Any";
          ...
          mediainfo = {
            ...
            exec = "${pkgs.fish}/bin/fish -c '${pkgs.mediainfo}/bin/mediainfo %F; read -n 1 -p \"echo Press any key to continue...\"'";
            icon = "media-video";
            selection = "s";
            extensions = null;
