...
in
{
  ...
  config = {
    ...
    programs.firefox = {
      ...
      profiles = {
        gabe = {
          ...
          userChrome = lib.mkIf cfg.useCustomCss (builtins.readFile ./userChrome.css);
          userContent = lib.mkIf cfg.useCustomCss (builtins.readFile ./userContent.css);
            ...
            engines =
              ...
              in
              {
                ...
                "AUR" = {
                  ...
                  urls = [
                    {
                      template = "https://aur.archlinux.org/packages?O=0&K={searchTerms}";
                    }
                  ];
                ...
                "Amazon CA" = {
                  inherit updateInterval;
                  urls = [ { template = "https://www.amazon.ca/s?k={searchTerms}"; } ];
    ...
    xdg.desktopEntries."firefox-nightly" =
      let
