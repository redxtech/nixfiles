    ...
    }:
    {
      packages =
        let
          ...
          filteredHosts = filter (hostname: hostname != "nixiso") (attrNames self.nixosConfigurations);
          ...
          mkAgent =
            ...
            cachix-deploy-lib.spec {
              agents.${name} = self.nixosConfigurations.${name}.config.system.build.toplevel;
            };
