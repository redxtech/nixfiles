...
| [`cua-driver`](packages/cua-driver/package.nix) | `0.23.2` | Cross-platform MCP server for computer-use automation | [source](https://github.com/trycua/cua) |
...
| [`mcp-remote`](packages/mcp-remote/package.nix) | `0.8.3` | Remote proxy for Model Context Protocol clients | [source](https://github.com/geelen/mcp-remote) |
...
| [`home-assistant-components-tuya-local`](packages/home-assistant/components/tuya_local/package.nix) | `2026.8.1` | Local support for Tuya devices in Home Assistant | [source](https://github.com/make-all/tuya-local) |
...
| [`home-assistant-lovelace-custom-brand-icons`](packages/home-assistant/lovelace/custom-brand-icons/package.nix) | `2026.08.5` | Custom brand icons for Home Assistant | [source](https://github.com/elax46/custom-brand-icons) |
