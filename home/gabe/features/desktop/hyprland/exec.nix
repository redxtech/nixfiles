          ...
          text = ''
            handle() {
              case $1 in monitoradded*)
                # reassign monitors
                # hyprctl keyword "monitor" "''${config.desktop.primaryMonitor},2560x1440,0x0,1"
                # hyprctl keyword "monitor" "''${(builtins.elemAt config.desktop.monitors 1).name},2560x1440,2560x0,1"
